...
class Uploader{
	...
	function uploadFile($file,$custom_name=null){
		$name=($custom_name!=null) ? $custom_name : $file['name'];
		if(move_uploaded_file($file['tmp_name'], (($this->getDirectory()).$name))) return $name;
		else return false;
	}
